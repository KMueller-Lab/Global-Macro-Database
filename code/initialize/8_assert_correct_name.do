qui {
	...
	* 
	* Description: 
	* This Stata program checks that all variables have correct names
	*
	* Author:
	* Mohamed Lehbib
	...
	* Assert that the only not matched file in the run_input_variables which contains nGDP, pop, and USDfx combine code 
	cap assert _merge == 3 if codes !=  "A_run_input_variables" & codes != "A_run_input_variables_2" & codes != "Heatmaps_by_country" & codes != "CA_GDP" & codes != "CA_USD"
