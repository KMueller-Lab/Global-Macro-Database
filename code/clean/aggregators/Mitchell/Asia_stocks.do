...
global output "${data_temp}/MITCHELL/Asia_stocks"
...
* Convert units
local countries HongKong India Iran Nepal Pakistan Philippines SaudiArabia Taiwan Thailand Japan SouthKorea Turkey
...
* Convert units
replace stocks = stocks * (10^-6) if year <= 1998 & countryname == "Turkey"
replace stocks = stocks * (10^-3) if year >= 1999 & countryname == "Turkey"
replace stocks = stocks * (10^-4) if year <= 1939 & countryname == "Taiwan"
replace stocks = stocks / 4 if year <= 1939 & countryname == "Taiwan"
