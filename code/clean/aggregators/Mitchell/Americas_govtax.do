...
global output "${data_temp}/MITCHELL/Americas_govtax"
...
* Calculate total tax revenue
egen USAtax = rowtotal(USA Q)
egen Canadatax = rowtotal(Canada D)
keep year *tax
ren *tax *
...
* Calculate total tax revenue
egen USAtax = rowtotal(USA X Y Z)
egen Canadatax = rowtotal(Canada D E F)
egen Mexicotax = rowtotal(Mexico Q)
keep year *tax
ren *tax *
...
* Convert 
replace govtax = govtax / 1000 if countryname == "Mexico"
