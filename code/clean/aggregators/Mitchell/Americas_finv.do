...
global output "${data_temp}/MITCHELL/Americas_finv"
...
foreach var in `r(varlist)' {
	...
	if `var'[3] == "current prices" &  inlist(`var'[4], "gfcf", "gpfcf") {
...
replace finv = finv / 1000 if countryname == "Nicaragua" & year <= 1989
replace finv = finv / 1000 if countryname == "Nicaragua" & year <= 1987
replace finv = finv / 1000 if countryname == "Mexico"    & year <= 1984
replace finv = finv / 8.75 if countryname == "ElSalvador"    & year <= 1993
