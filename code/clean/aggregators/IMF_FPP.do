...
global input "${data_raw}/aggregators/IMF/IMF_FPP/IMF_FPP_2025.dta"
global output "${data_clean}/aggregators/IMF/IMF_FPP/IMF_FPP.dta"
...
gen govdef_GDP = pb - ie // the same rev - exp 
drop pb ie 
...
ren IMF_FPP_gov* IMF_FPP_gen_gov*
