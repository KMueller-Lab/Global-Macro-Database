...
clear
global input "${data_raw}/aggregators/WB/WB_infl/WB_infl.xlsx"
global output "${data_clean}/aggregators/WB/WB_infl/WB_infl.dta"
...
replace CPI = CPI_rebased
drop CPI_2010 CPI_2010_all CPI_rebased
sort ISO3 year

* Rename
ren infl WB_infl_infl
ren CPI WB_infl_CPI
