...
global input "${data_raw}/aggregators/Tena/Tena_trade"
global output "${data_clean}/aggregators/Tena/Tena_trade/Tena.dta"
...
merge 1:1 ISO3 year using `temp_USDfx', nogen
