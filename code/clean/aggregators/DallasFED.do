...
global input "${data_raw}/aggregators/DallasFED/DallasFED.xlsx"
global output "${data_clean}/aggregators/DallasFED/DallasFED.dta"
...
replace countryname="South Africa" if countryname=="SAfrica"
replace countryname="South Korea" if countryname=="SKorea"
qui kountry countryname, from(other) stuck
ren _ISO3N_ stuck
