...
gmdaddnote_source ECLAC    "Data refers to general government." govexp
...
splice, priority( OECD_EO EUS AFRISTAT AMF BCEAO IMF_GFS WDI IMF_WEO CS1 CS2 JST NBS ECLAC ADB AFDB Mitchell HFS AHSTAT IMF_WEO_forecast) generate(govexp) varname(govexp) method("chainlink") base_year(2018)
