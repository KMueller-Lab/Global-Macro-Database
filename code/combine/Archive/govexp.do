...
splice, priority( OECD_EO EUS AFRISTAT AMF BCEAO IMF_GFS WDI IMF_WEO CS1 CS2 JST NBS CEPAC ADB AFDB Mitchell HFS AHSTAT IMF_WEO_forecast) generate(govexp) varname(govexp) method("chainlink") base_year(2018)
