...
gmdaddnote_source ECLAC    "Data refers to general government." govrev
...
splice, priority( OECD_EO AMF BCEAO AFRISTAT IMF_GFS EUS  WDI AFDB ADB IMF_WEO CS1 CS2 JST ECLAC AHSTAT JERVEN Mitchell HFS NBS FZ IMF_WEO_forecast) generate(govrev) varname(govrev) base_year(2018) method("chainlink")
