...
splice, priority(AFRISTAT AMF BCEAO IMF_GFS EUS OECD_EO WDI WDI_ARC CS1 CS2 NBS ADB AHSTAT Mitchell JERVEN AHSTAT) generate(govtax) varname(govtax) method("chainlink") base_year(2017)
