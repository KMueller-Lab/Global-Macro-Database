...
\begin{document}
\title{\Large Country Data and Graphs for Kyrgyzstan}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/KGZ_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
...
\rowcolor{lightgray}\cite{ADB}& 2000 - 2013 &Spliced using overlapping data in 2014. Data refers to general government.\\
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{ADB}& 2000 - 2013 &Spliced using overlapping data in 2014. Data refers to general government.\\
\rowcolor{lightgray}\cite{WDI}& 2014 - 2023 &Baseline source, overlaps with base year 2018. Data refers to central government.\\
\hline
\end{tabular}
\end{table}
\begin{figure}[H]
