...
\begin{document}
\title{\Large Country Data and Graphs for Saint Helena, Ascension and Tristan da Cunha}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/SHN_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
