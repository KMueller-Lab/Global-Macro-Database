...
\begin{document}
\title{\Large Country Data and Graphs for Saint Pierre and Miquelon}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/SPM_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
