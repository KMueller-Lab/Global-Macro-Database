...
\begin{document}
\title{\Large Country Data and Graphs for Azerbaijan}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/AZE_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{IMF_HDD}& 1993 - 1993 &Spliced using overlapping data in 1994. Data refers to general government.\\
\rowcolor{lightgray}\cite{IMF_GDD}& 1994 - 2018 &Spliced using overlapping data in 2019. Data refers to central government.\\
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{IMF_WEO}& 1994 - 2021 &Baseline source, overlaps with base year 2018. Data refers to general government.\\
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{WDI}& 1994 - 1999 &Spliced using overlapping data in 2000. Data refers to general government.\\
\rowcolor{lightgray}\cite{ADB}& 2000 - 2007 &Spliced using overlapping data in 2008. Data refers to general government.\\
\rowcolor{white}\cite{WDI}& 2008 - 2022 &Baseline source, overlaps with base year 2018. Data refers to general government.\\
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{WDI}& 1994 - 1999 &Spliced using overlapping data in 2000. Data refers to central government.\\
\rowcolor{lightgray}\cite{ADB}& 2000 - 2007 &Spliced using overlapping data in 2008. Data refers to general government.\\
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{MAD}& 1982 - 1986 &Spliced using overlapping data in 1987: (ratio = 35.5\%). \\
