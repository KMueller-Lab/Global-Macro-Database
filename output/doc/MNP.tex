...
\begin{document}
\title{\Large Country Data and Graphs for Northern Mariana Islands}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/MNP_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
