...
\begin{document}
\title{\Large Country Data and Graphs for Bonaire, Sint Eustatius and Saba}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/BES_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
