...
\begin{document}
\title{\Large Country Data and Graphs for Curaçao}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/CUW_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{WB_CC}& 1972 - 1999 &Spliced using overlapping data in 2000. \\
