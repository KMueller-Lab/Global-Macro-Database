...
\begin{document}
\title{\Large Country Data and Graphs for Marshall Islands}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/MHL_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{IMF_WEO}& 1997 - 2003 &Spliced using overlapping data in 2004. Data refers to general government.\\
