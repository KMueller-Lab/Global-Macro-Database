...
\begin{document}
\title{\Large Country Data and Graphs for Grenada}
\date{June 30, 2025}
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphs/GRD_heatmap.pdf}
\end{figure}
\setcounter{page}{3}
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{IMF_MFS}& 1970 - 2008 &Spliced using overlapping data in 2009. \\
...
\textbf{Source} & \textbf{Time span} & \textbf{Notes} \\
\hline
\rowcolor{white}\cite{WDI_ARC}& 1977 - 1995 &Spliced using overlapping data in 1996. Data refers to central government.\\
\hline
\end{tabular}
\end{table}
\begin{figure}[H]
